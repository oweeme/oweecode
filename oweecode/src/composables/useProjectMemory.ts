...
// gets saved here isn't locked into OweeCode's own chat, it's picked up by
...
const HEADER = `# Contexto del proyecto (AGENTS.md)\n\nResumen compartido para que cualquier asistente de IA (Claude Code, Aider, el chat de OweeCode, etc.) continúe con el contexto de este proyecto sin partir de cero.\n`
